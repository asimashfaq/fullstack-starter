...
import SwitchButton, {
  AllTranslationsNeeded as SwitchButtonAllTranslationsNeeded,
} from '../SwitchButton';
import SwtichLink, {
  AllTranslationsNeeded as SwitchLinkAllTranslationsNeeded,
} from '../SwitchLink';
...
const Component: React.FC = () => {
  ...
  return (
    <header>
      <nav>
        <Link href="">
          <a>{(translations.pages as JsonMap)['/']}</a>
        </Link>

        <Link href="/ssr">
          <a>{(translations.pages as JsonMap).ssr}</a>
        </Link>

        <Link href="/dynamic">
          <a>{(translations.pages as JsonMap).dynamic}</a>
        </Link>
