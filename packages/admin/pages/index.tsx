...
import {
  GetI18nProps,
  getI18nCookieFromUnparsedCookieHeader,
} from '../utils/i18n';
...
export const getServerSideProps: GetServerSideProps<GetI18nProps> = async ({
  req,
  res,
}) => {
  ...
  const acceptLanguageSub = acceptLanguageHeader
    ? acceptLanguageHeader.substring(0, 2)
    : undefined;
  ...
  const finalLanguage =
    preferredLanguage || acceptLanguage || defaultLanguage.prefix;
